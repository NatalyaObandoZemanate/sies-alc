...
include '../../controladores/planEstudios/controllerSemestresProgramas.php';
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-12">
          <h1 class="m-0">Plan de estudios de <?php echo $nom_pro?></h1>
          <hr>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
          <div class="col-sm-12">
            <!-- División por semestre -->
            <?php
            include '../../controladores/planEstudios/controllerListarPlanEstudios.php';
            $semestre = 1;
            for ($i=0; $i < $sem_pro; $i++) {
              ?>
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Semestre #<?php echo $semestre ?></h3>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>
                                ...
                                <div class="btn-group">
                                  <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-view-<?php echo $contador?>" title="Ver plan de estudios">
                                ...
                                <!-- Fin visualización de plan de estudios -->
                                <!-- Actualización de plan de estudios -->
                                <div class="btn-group">
                                  <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-update-<?php echo $contador?>" title="Actualizar">
                                ...
                                <!-- Fin actualización de plan de estudios -->
                                <div class="btn-group">
